...
function initI18n() {
    I18N = {
        en: {
            ...
            device: "For the best experience, please view this page on a desktop browser in full-screen mode.",
        ...
        ja: {
            ...
            device: "本ページは情報量が多いため、PCブラウザの全画面表示での閲覧を推奨します。",
            whatIf: "試合結果",
            clear: "リセット",
            views: "チーム別ビュー",
            teams: "チーム",
        ...
        zh: {
            ...
            device: "请在电脑浏览器的全屏模式下浏览本页面，以获得最佳体验。",
            whatIf: "假设赛果是……",
            clear: "重置",
            views: "各队情况图",
            teams: "队",
